...
namespace edu.uwec.cs.cs355.group4.et.db {
    internal class CandidateDAO : HibernateDAO<Candidate> {
        ...
        protected override IList<Fault> performValidation(Candidate entity) {
            ...
            IQuery validQuery =
                   currentSession.CreateSQLQuery("select * from candidate where CandidateFirstName = '" + entity.FirstName + "' and CandidateLastName = '" + entity.LastName + "' and CandidateID != " + entity.ID + ";").AddEntity(objectType);
